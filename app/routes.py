...
def register_routes(app):
    ...
    def index():
        ...
        # Não precisamos buscar avisos aqui, pois já são injetados pelo context processor
        # Os avisos são injetados globalmente pelo context processor inject_avisos()
